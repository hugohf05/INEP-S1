...
#include <iostream>
#include "Connexio.cpp"
#include "CapaDePresentació.cpp"
#include <cppconn/exception.h>

using namespace std;

void registreUsuari(ConnexioBD& connexio, CapaDePresentacio& CP) {
    CP.registreUsuari(connexio);
}
...
void gestioUsuari(ConnexioBD& connexio, CapaDePresentacio& CP) {
    int opt2;
    cout << "1. Registre usuari" << endl;
    cout << "2. Consulta usuari" << endl;
    cout << "3. Modifica usuari" << endl;
